...
main = do
  ...
  p_zeroes <- return $! rin_solve poly "xy" 0.1 0.1 [Interval (-3) 3, Interval (-3) 3] 
  p_leaf_data <- return $! leaf_rin_solve poly "xy"  0.001 0.0001 0.0000001[Interval (-3) 3, Interval (-3) 3]
